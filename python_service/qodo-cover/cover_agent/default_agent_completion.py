...
class DefaultAgentCompletion(AgentCompletionABC):
    ...
    def fix_test(
        ...
        """
        Attempts to fix a failing test based on the error message using 'fix_test_prompt.toml'.
        
        Args:
            source_file_name (str): Name of the source file.
            source_file (str): Content of the source file.
            test_code (str): The failing test code.
            error_message (str): The stderr/stdout indicating the failure.
            language (str): Programming language.
            test_file_name (str): Name of the test file.

        Returns:
            Tuple[str, int, int, str]: (Fixed test code, input tokens, output tokens, prompt).
        """
        prompt = self._build_prompt(
            file="fix_test_prompt", 
            source_file_name=source_file_name,
